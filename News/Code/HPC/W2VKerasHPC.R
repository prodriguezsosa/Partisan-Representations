...
# set paths
in_path <- "/scratch/plr250/WordEmbeddings/PartisanEmbeddings/News/Inputs/"
out_path <- "/scratch/plr250/WordEmbeddings/PartisanEmbeddings/News/Outputs/"
...
# load data
# ================================
#corpus <- readRDS(paste0("/Users/pedrorodriguez/Dropbox/GitHub/Partisan-Representations/Inputs/", SOURCE, "_corpus.rds"))
#vocab <- readRDS("/Users/pedrorodriguez/Dropbox/GitHub/Partisan-Representations/Inputs/vocab_list.rds")
...
# ================================
vocab <- intersect(vocab[["FOX"]], vocab[["MSNBC"]]) # intersection of the top N terms in all sources
...
skipgrams_generator <- function(text, tokenizer, window_size, negative_samples) {
  ...
  gen <- texts_to_sequences_generator(tokenizer, text) # sample beforehand with seed
  function() {
...
# save embeddings
# ================================
saveRDS(embedding_matrix, paste0(out_path, SOURCE, "_", VOCAB_SIZE, "_", WINDOW_SIZE, "_", EPOCHS, "_embedding_matrix.rds"))
