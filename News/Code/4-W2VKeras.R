...
# set paths
in_path <- "/Users/pedrorodriguez/Dropbox/GitHub/Partisan-Representations/Inputs/"
out_path <- "/Users/pedrorodriguez/Dropbox/GitHub/Partisan-Representations/Output/"
...
# load data
# ================================
corpus <- readRDS(paste0(in_path, SOURCE, "_", N, "_corpus.rds"))
